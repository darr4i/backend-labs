...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $created_at = date("Y-m-d H:i:s"); // Поточна дата і час

    $sql = "INSERT INTO books (title, author, year, author_address, publisher_address, price, bookstore, created_at) 
            VALUES ('$title', '$author', '$year', '$author_address', '$publisher_address', '$price', '$bookstore', '$created_at')";
...
<form method="post">
    ...
    <!-- Приховане поле для дати створення -->
